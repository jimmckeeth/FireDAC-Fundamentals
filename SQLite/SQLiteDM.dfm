object sqlite: Tsqlite
  ...
  object FDConnection: TFDConnection
    Params.Strings = (
      'DriverID=SQLite'
        ...
        'Database=C:\Users\jim\Downloads\Fundamental SQL\SQLite\sqlite.sd' +
        'b'
      'LockingMode=Normal'
      'JournalMode=WAL')
    Connected = True
    ...
    SQLScripts = <
      item
        ...
        SQL.Strings = (
          ...
          #9'region_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'region_name NVARCHAR  NOT NULL'
          ');'
          ''
          'CREATE TABLE countries ('
          #9'country_id NCHAR(2)  NOT NULL,'
          #9'country_name NVARCHAR  NOT NULL,'
          #9'region_id INTEGER NOT NULL,'
          #9'PRIMARY KEY (country_id ASC),'
          ...
          #9'location_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'street_address NVARCHAR ,'
          #9'postal_code NVARCHAR ,'
          #9'city NVARCHAR  NOT NULL,'
          #9'state_province NVARCHAR ,'
          #9'country_id NCHAR(2) NOT NULL,'
          ...
          #9'department_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'department_name NVARCHAR  NOT NULL,'
          ...
          ''
          'CREATE TABLE jobs ('
          #9'job_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'job_title NVARCHAR  NOT NULL,'
          #9'min_salary CURRENCY NOT NULL,'
          #9'max_salary CURRENCY NOT NULL'
          ');'
          ''
          'CREATE TABLE employees ('
          #9'employee_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'first_name NVARCHAR ,'
          #9'last_name NVARCHAR  NOT NULL,'
          #9'email NVARCHAR  NOT NULL,'
          #9'phone_number NVARCHAR ,'
          #9'hire_date DATETIME  NOT NULL,'
          #9'job_id INTEGER NOT NULL,'
          #9'salary CURRENCY NOT NULL,'
          #9'manager_id INTEGER,'
          #9'department_id INTEGER NOT NULL,'
            ...
            #9'FOREIGN KEY (manager_id) REFERENCES employees (employee_id) ON ' +
            'DELETE CASCADE ON UPDATE CASCADE'
          ');'
          ''
          'CREATE TABLE dependents ('
          #9'dependent_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,'
          #9'first_name NVARCHAR  NOT NULL,'
          #9'last_name NVARCHAR  NOT NULL,'
          #9'relationship NVARCHAR  NOT NULL,'
  ...
  object FDQueryEmployees: TFDQuery
    ...
    object FDQueryEmployeeshire_date: TDateTimeField
      FieldName = 'hire_date'
    end
    object FDQueryEmployeessalary: TCurrencyField
      FieldName = 'salary'
    end
  end
  ...
  object FDQueryJobs: TFDQuery
    ...
    Left = 272
    Top = 110
    object FDQueryJobsjob_id: TFDAutoIncField
      FieldName = 'job_id'
      Origin = 'job_id'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = False
    ...
    object FDQueryJobsjob_title: TWideStringField
      DisplayWidth = 30
      FieldName = 'job_title'
      Origin = 'job_title'
      Required = True
    ...
    object FDQueryJobsmin_salary: TCurrencyField
      FieldName = 'min_salary'
      Origin = 'min_salary'
      Required = True
    end
    object FDQueryJobsmax_salary: TCurrencyField
